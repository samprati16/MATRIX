...
<body>
    <div class="grid-transfer">
        ...
        <div class="b-5"></div>
        <div class="c3"></div>
        <div class="b-6" id="ft"><h2>Add Money</h2> <br><br><br>
            <form class="details" name = "transfer" method="POST" action="madd.jsp">
                ...
                <input type="number" required="required" max="100000" class="amt1" name="amt" placeholder="0"><br><br><br>

                <input type="submit" value="Submit" class="t-btn1"/>
              </form> 
        </div>
        <div class="logout1">
