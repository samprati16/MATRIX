...
<body>
    <div class="grid-ptnc">
        <div class="tnc-back">
            <a href="businessreg.jsp"><button class="banking-btnp"><i class="fas fa-chevron-left"></i></button></a>
        </div>
        <div class="tnc-wh"></div>
        <div class="tnc-logo">
            <h2>M</h2>
        </div>
        <div class="tnc-wh1"></div>
        <div class="tnc-wh2"></div>
        <div class="tnc-h1">
            <h2><i class="fas fa-scroll"></i> Terms and Conditions</h2> <br>
            <h3>General site usage</h3>
            <p class="tnc-p">Welcome to MATRIX. This site is provided as a service to our 
                customers and may be used for informational purposes only. Because the Terms and Conditions 
                contain legal obligations, please read them carefully.</p><br>
        </div>
        <div class="tnc-wh3"></div>
        <div class="tnc-wh4"></div>
        <div class="tnc-h2">
            <h3>Agreement</h3>
            <p class="tnc-p">By accessing this website we assume you accept these terms and conditions. 
                Do not continue to use Matrix if you do not agree to take all of the terms and conditions 
                stated on this page. The following terminology applies to these Terms and Conditions,
                Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your"
                refers to you, the person log on this website and compliant to the Company terms and 
                conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. 
                "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer 
                ...
                accordance with and subject to, prevailing law of Netherlands. Any use of the above terminology
                or other words in the singular, plural, capitalization and/or he/she or they, are taken as 
                interchangeable and therefore as referring to same.
                <br> <br>

                <span class="tncmainpara">License</span> <br>
                Unless otherwise stated, MATRIX and/or its licensors own the intellectual property rights for
                all material on Matrix. All intellectual property rights are reserved. You may access this from 
                Matrix for your own personal use subjected to restrictions set in these terms and conditions. <br><br>
                
                You must not: <br>
                <ul class="tnc-ul">
                    <li>Republish material from Matrix</li>
                    <li>Sell, rent or sub-license material from Matrix</li>
                    <li>Reproduce, duplicate or copy material from Matrix</li>
                    <li>Redistribute content from Matrix</li>
                </ul> <br>
            </p>

            <p class="tnc-p"> <span class="tncmainpara">Hyperlinking to our Content</span><br>
            ...
            <p class="tnc-p">
                ...
                compensates the absence of MATRIX; and (d) the link is in the context of general resource 
                information. <br><br>
                ...
                products or services; and (c) fits within the context of the linking party's site. <br><br>
            ...
            <p class="tnc-p">
                No use of MATRIX's logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p> <br>

            <p class="tnc-p"> <span class="tncmainpara">Content Liability</span><br>
            ...
            <p class="tnc-p"> <span class="tncmainpara">Reservation of Rights</span><br>
            ...
            <p class="tnc-p"> <span class="tncmainpara">Removal of links from our website</span><br>
                ...
                not obligated to or so or to respond to you directly. <br> <br>
            ...
            <p class="tnc-p"> <span class="tncmainpara">Disclaimer</span><br>
            ...
            <p class="tnc-p">
                ...
                disclaimer, including liabilities arising in contract, in tort and for breach of statutory duty. <br><br>
